...
class Control
{
  ...
  public static function index($name ,$view = null , $compact = [],$callback = null)
  {
    if (is_null($view)) 
    {
      $view = user('rule').'_rule.'.strtolower(str_plural($name)).'.index';
    }
  ...
  public static function create($name ,$view = null , $compact = [])
  {
    if (is_null($view)) 
    {
      $view = user('rule').'_rule.'.strtolower(str_plural($name)).'.create';
    }
  ...
  public static function edit($name , $id , $view = null , $compact = [])
  {
    if (is_null($view)) 
    {
      $view = user('rule').'_rule.'.strtolower(str_plural($name)).'.edit';
    }
